document.addEventListener("DOMContentLoaded", function() {
    ...
    // Colori per gli esagoni esterno ed interno
    var outerColors = ["#FF6347", "#FFD700", "#ADFF2F", "#40E0D0", "#1E90FF", "#DA70D6"];
    var innerColors = ["#8B4513", "#2E8B57", "#FFA07A", "#4682B4", "#D2691E", "#6A5ACD"];
    ...
    var outerPoints = calculateHexagonPoints(center, outerHexagonSize);
    var innerPoints = calculateHexagonPoints(center, innerHexagonSize);

    drawAndDecorateHexagon(outerPoints, outerColors, false); // Per l'esagono esterno
    drawAndDecorateHexagon(innerPoints, innerColors, true); // Per l'esagono interno
});
